...
\begin{document}
    ...
    {
		\usebackgroundtemplate{\includegraphics[width=\paperwidth]{background/title-c.png}}
		\frame{\titlepage}
    }
    
    \usebackgroundtemplate{\includegraphics[width=\paperwidth]{background/slide-r.png}}
